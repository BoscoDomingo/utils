A personal collection of utilities, tools and scripts across various languages and frameworks.
...
(If present) Refer to `./docs/decisions/` for architectural decisions, including a template for ADRs.

(If present) Refer to `./docs/agents/` for your instructions and sub-agent-specific instructions. Use Sub-agents aggressively to prevent context bloat.
