...
func TestCopyPlanAndExecution(t *testing.T) {
	t.Parallel()

	t.Run("requires_recursive_for_directories", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("requires_directory_for_multiple_sources", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("copies_nested_directory_with_preserve", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("honors_force_flag", func(t *testing.T) {
		t.Parallel()
